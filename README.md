...
```
    ...
    --actor_rollout_ref.rollout.log_prob_micro_batch_size_per_gpu: Batch size of a rollout for a single gpu
    --actor_rollout_ref.rollout.tensor_model_parallel_size: Number of copies of the model sharded
